...
**思ったこと**  
   * `愚直解からいかに計算量を減らすかで挫折しがち。今日は、大量のクエリの計算量を事前計算でO(1)にする知見を得た。大量のクエリが飛ぶときはクエリ一つに対する計算量の軽量化を図ってみることもだいじ！
...
**思ったこと**  
   * 問題文や条件から使えそうな公式やらなんやらをかぎつけるのはそれなりの嗅覚のようなものが必要な気がする。
   慣れてる問題ならMapとか累積和使ってくださいって感じのが見えてくるけど慣れてないとおおよその当たりがつかない。
   これってかなりでかいよな…
